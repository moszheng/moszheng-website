...
<template>
    <section
        class="about-hero d-flex-center mb-12 h-svh flex-wrap px-3 pt-5 xl:mb-0 xl:h-screen xl:px-10 xl:py-12 2xl:px-16"
    >
        <!-- profile image -->
        <div class="d-flex-center mt-16 mb-5 pr-4 pl-4 xl:mt-0 xl:mb-0 2xl:w-1/2">
            <div
                class="profile-container parallax will-change-transform-opacity relative max-h-[600px] min-h-[56vmin] w-[48vmin] overflow-hidden max-xl:min-h-[40vmax] max-xl:w-[35vmax]"
                data-depth="2"
                data-scale="1.2"
            >
                <!-- profile-container
                ...
                -->
                <figure
                    class="will-change-transform-opacity absolute z-20 h-full scale-[1.2] blur-none"
                    id="profile-img-1"
                >
                    <div
                        class="parallax heroRot will-change-transform-opacity h-full"
                        data-depth="1.05"
                        data-scale="1.05"
                    >
                        <LazyImage
        ...
        <div
            ...
            :class="{
                'text-main-neutral': store.navbardarkmode,
                'text-stone-950': !store.navbardarkmode,
            }"
        >
            <div class="relative mb-3 md:mb-1">
                ...
                <h1 class="mobile-center mb-2 md:mb-0">
                    <span
                        v-for="(text, index) in splitText('Hello, I\'m')"
                        :key="index"
                ...
                <h1 class="mobile-center mb-8 md:mb-10">
                    <span
                        v-for="(text, index) in splitText('Sheng Wen Cheng')"
                        :key="index"
                        class="inline-flex pe-2 xl:pe-4"
                    >
                    ...
                    <div class="flex flex-col items-center">
                        <h4 class="mb-10 text-center md:mb-12 md:text-left">
                            <span class="block font-bold" id="hero-detail">
                                ...
                                <strong class="text-main-orange">Motion Designer</strong>
                                <br />
                            </span>
                            <span class="block font-bold" id="hero-detail"> based in Taiwan. </span>
                        </h4>
                        <div class="flex rotate-180 items-center" id="hero-4">
                            <svg
