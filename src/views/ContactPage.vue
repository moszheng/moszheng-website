            ...
            <div class="flex-fill flex w-full flex-wrap px-4 py-5 lg:px-0 xl:mb-6">
                ...
                <div class="contact-form w-full lg:max-w-(--breakpoint-sm) xl:w-1/2">
                    <form action="https://formspree.io/f/meqbdlnk" method="POST">
                        ...
                        <button
                            type="submit"
                            class="btn bg-main-orange inline-block h-10 w-full rounded-lg border px-3 py-1 text-center align-middle text-base leading-normal text-white no-underline duration-300 select-none hover:bg-orange-400 lg:w-1/3"
                        >
                            Send
                        </button>
                    </form>
